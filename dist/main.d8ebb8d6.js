...
var sectionOne = document.querySelector('.hero-wrapper');
var sections = document.querySelectorAll('.alignment');
var options = {
  root: null,
  rootMargin: '-150px',
  threshold: 0
...
var observer = new IntersectionObserver(function (entries, observer) {
  return entries.forEach(function (entry) {
    if (entry.isIntersecting) {
      ...
      entry.target.classList.toggle('test'); //  remove invisible class when intersects
    } else {//  add invisible class when false
    }
